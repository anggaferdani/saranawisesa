...
class PesertaController extends Controller
{
    ...
    public function pemenang($lelang_id, $id){
        ...
        $message = 'Dengan inimemberitahukan kepada Anda bahwa perusahaan Anda, ' . $user->nama_panjang . ', telah terpilih sebagai pemenang dalam proses pengadaan ' . $lelang->nama_lelang . '.';
