    ...
    <ul class="sidebar-menu">
      ...
      @if(Session::has('eproc'))
        @if(auth()->user()->level == 'superadmin')
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu" style="display: block;">
              ...
              <li><a class="nav-link" href="{{ route('eproc.superadmin.perusahaan.index') }}"><span>Perusahaan</span></a></li>
            </ul>
          </li>
        ...
        @if(auth()->user()->level == 'admin')
          ...
          <li class="menu-header">Menu</li>
          <li><a class="nav-link" href="{{ route('eproc.admin.perusahaan.index') }}"><i class="far fa-square"></i><span>Perusahaan</span></a></li>
