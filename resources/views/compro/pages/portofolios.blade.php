...
@section('title', 'Index')
@section('content')
<section class="py-5" style="background: url({{ asset('img/gedung5.png') }}); background-size: cover; background-repeat: no-repeat; background-position: center;">
  <div class="container py-5 h-100">
    <div class="row py-5 justify-content-center text-center align-items-center h-100">
      <div class="col text-white"><h1>PORTOFOLIOS</h1></div>
    </div>
  </div>
</section>
    ...
    <div class="row row-cols-1 row-cols-md-3 row-cols-lg-3 g-2 mt-2">
      ...
      <div class="col">
        <div class="card rounded-4 shadow-sm">
          ...
          <div class="card-body">
            <h5 class="card-title mt-2">{{ Str::limit($portofolio->judul_portofolio, 15) }}</h5>
