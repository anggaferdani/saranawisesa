...
<div class="section-header-breadcrumb">
  ...
  <div class="breadcrumb-item active"><a href="#">Tambah Direksi</a></div>
</div>
@endsection
@section('content')
<div class="row">
    ...
    <div class="card">
      <div class="card-body">
        @if(auth()->user()->level == 'superadmin')
          <form method="POST" action="{{ route('compro.superadmin.direksi.store') }}" class="needs-validation" enctype="multipart/form-data" novalidate="">
        @endif
        @if(auth()->user()->level == 'admin')
          <form method="POST" action="{{ route('compro.admin.direksi.store') }}" class="needs-validation" enctype="multipart/form-data" novalidate="">
        @endif
          @csrf
          <div class="form-group">
            <label for="nama_direksi">Nama Direksi</label>
            <input id="nama_direksi" type="text" class="form-control" name="nama_direksi">
            @error('nama_direksi')<div class="text-danger">{{ $message }}</div>@enderror
          </div>
          <div class="form-group">
            <label for="direksi">Direksi</label>
            <input id="direksi" type="file" class="form-control" name="direksi" onchange="file(event)">
          ...
          <div class="form-group">
            ...
            <input id="jabatan_direksi" type="text" class="form-control" name="jabatan_direksi">
