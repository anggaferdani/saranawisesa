...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        ProfilePerusahaan::create([
            'sejarah_perusahaan' => '<p>PT SARANAWISESA PROPERINDO adalah anak perusahaan Perumda Pembangunan Sarana Jaya ( BUMD milik Pemerintah Provinsi DKI Jakarta ) berdiri sejak tanggal 3 Februari 1993 yang bergerak dibidang Property. Seiring dengan perkembangan perusahaan yang semakin pesat maka kami melakukan diversifikasi usaha dengan mengembangkan bisnis baru di bidang Sarana Parkir, Management Properti, Agen Properti, Supplier serta Interior &amp; Landscape.</p>',
            'visi' => '<ul><li>Menjadi Perusahaan Pengembang yang Terkemuka dan Berkelanjutan di Indonesia</li></ul>',
            'misi' => '<ul><li>Mengembangkan bisnis properti yang mendukung strategi dan program kerja Pemerintah Provinsi Daerah Khusus Ibukota Jakarta</li><li>Menjalin kemitraan strategis untuk menciptakan nilai (value creation) produk dan jasa yang dapat memberikan manfaat kepada masyarakat luas</li><li>Berperan aktif dalam mendorong pembangunan kawasan di perkotaan</li></ul>',
        ]);
