      ...
      <div class="card-body">
        <form method="POST" action="{{ route('eproc.perusahaan.lampiran-kualifikasi.update', ['user_id' => Crypt::encrypt(Auth::id())]) }}" class="needs-validation" enctype="multipart/form-data" novalidate="">
          ...
          <div class="form-group">
            ...
            <input type="file" class="form-control" name="bukti_kepemilikan_tempat_usaha" value="{{ $lampiran_kualifikasi->bukti_kepemilikan_tempat_usaha }}">
          ...
          <div class="form-group">
            ...
            <input type="file" class="form-control" name="surat_izin_usaha" value="{{ $lampiran_kualifikasi->surat_izin_usaha }}">
          ...
          <div class="form-group">
            ...
            <input type="file" class="form-control" name="surat_izin_lainnya" value="{{ $lampiran_kualifikasi->surat_izin_lainnya }}">
          ...
          <div class="form-group">
            ...
            <input type="file" class="form-control" name="bukti_laporan_pajak_tahun_terakhir" value="{{ $lampiran_kualifikasi->bukti_laporan_pajak_tahun_terakhir }}">
          ...
          <div class="form-group">
            ...
            <input type="file" class="form-control" name="bukti_status_kepemilikan_fasilitas" value="{{ $lampiran_kualifikasi->bukti_status_kepemilikan_fasilitas }}">
