      ...
      <div class="card-body">
        ...
        @endif
          ...
          <div class="form-group">
            ...
            <input id="rencana_umum_pengadaan" type="text" class="form-control" name="rencana_umum_pengadaan" value="{{ $lelang->rencana_umum_pengadaan }}">
          ...
          <div class="form-group">
            ...
            <input id="tahap_lelang_saat_ini" type="text" class="form-control" name="tahap_lelang_saat_ini" value="{{ $lelang->tahap_lelang_saat_ini }}">
            @error('tahap_lelang_saat_ini')<div class="text-danger">{{ $message }}</div>@enderror
          </div>
          <div class="form-group">
            <label for="klpd">K/L/PD</label>
            <input id="klpd" type="text" class="form-control" name="klpd" value="{{ $lelang->klpd }}">
            @error('klpd')<div class="text-danger">{{ $message }}</div>@enderror
          </div>
          <div class="form-group">
            <label for="satuan_kerja">Satuan Kerja</label>
            <input id="satuan_kerja" type="text" class="form-control" name="satuan_kerja" value="{{ $lelang->satuan_kerja }}">
          ...
          <div class="form-group">
            ...
            <input id="metode_pengadaan" type="text" class="form-control" name="metode_pengadaan" value="{{ $lelang->metode_pengadaan }}">
            @error('metode_pengadaan')<div class="text-danger">{{ $message }}</div>@enderror
          </div>
          <div class="form-group">
            <label for="tahun_anggaran">Tahun Anggaran</label>
            <input id="tahun_anggaran" type="text" class="form-control" name="tahun_anggaran" value="{{ $lelang->tahun_anggaran }}">
            @error('tahun_anggaran')<div class="text-danger">{{ $message }}</div>@enderror
          </div>
          <div class="form-group">
            <label for="nilai_pagu_paket">Nilai Pagu Paket</label>
            <input id="nilai_pagu_paket" type="text" class="form-control" name="nilai_pagu_paket" value="{{ $lelang->nilai_pagu_paket }}">
          ...
          <div class="form-group">
            ...
            <input id="bobot_teknis" type="text" class="form-control" name="bobot_teknis" value="{{ $lelang->bobot_teknis }}">
