        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                  <label for="nama_panjang">Direktur</label>
                  <input id="nama_panjang" type="text" class="form-control" name="nama_panjang" wire:model="nama_panjang">
                  @error('nama_panjang')<div class="text-danger">{{ $message }}</div>@enderror
                </div>
                <div class="form-group">
                  <label for="email">Email Direktur</label>
                  <input id="email" type="email" class="form-control" name="email" wire:model="email">
                  @error('email')<div class="text-danger">{{ $message }}</div>@enderror
                </div>
                <div class="form-group">
                  <label for="password">Password</label>
                  <input id="password" type="text" class="form-control" name="password" wire:model="password">
