...
@section('title')
@section('header')
<h1>Tambah Atrikel</h1>
<div class="section-header-breadcrumb">
  <div class="breadcrumb-item"><a href="#">Dashboard</a></div>
  <div class="breadcrumb-item active"><a href="#">Tambah Atrikel</a></div>
</div>
@endsection
@section('content')
<div class="row">
      ...
      <div class="card-body">
        ...
        @endif
          ...
          <div class="form-group">
            ...
            <input id="judul_artikel" type="text" class="form-control" name="judul_artikel">
          ...
          <div class="form-group">
            ...
            <textarea id="isi_artikel" class="form-control" name="isi_artikel"></textarea>
